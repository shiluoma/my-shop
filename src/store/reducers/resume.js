import {
  SAVE_RESUME_LIST,
  SAVE_RESUME_DIRECT,
  SAVE_RESUME_CARD_INFO,
  SAVE_RESUME_TEMPLATES,
...
export default function resume(state = initState, action) {
  switch (action.type) {
    case SAVE_RESUME_LIST:
      return {
        ...state,
        onlineResume: action.payload.onlineResume,
        adjunctResume: action.payload.adjunctResume
      };
    ...
    case SAVE_RESUME_DETAIL:
      return { ...state, resumeDetail: { ...action.payload } };
    case SAVE_DIRECTION:
      return { ...state, selectedDirection: { ...action.payload } };
    case SAVE_SELECT_COURSE:
      return { ...state, resumeCourse: { ...action.payload } };
    case SAVE_EDIT_DATA:
